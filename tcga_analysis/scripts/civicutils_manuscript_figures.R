...
## 6C) DISTRIBUTION OF OVERALL CONSENSUS DRUG PREDICTIONS PER "CT" CLASS

# Use fractions of predicted consensus drugs per ct class overall
# Sanity check that required input columns can be found
overall_consensus_drugs_per_ct_columns = c("percent_all_support_drugs_ct", "percent_all_resistance_drugs_ct", "percent_all_conflict_drugs_ct", "percent_all_unknown_drugs_ct", "percent_mixed_drugs_ct",
                                           "percent_all_support_drugs_gt", "percent_all_resistance_drugs_gt", "percent_all_conflict_drugs_gt", "percent_all_unknown_drugs_gt", "percent_mixed_drugs_gt",
                                           "percent_all_support_drugs_nct", "percent_all_resistance_drugs_nct", "percent_all_conflict_drugs_nct", "percent_all_unknown_drugs_nct", "percent_mixed_drugs_nct")
df_overall_consensus_drugs_per_ct_snv_sorted = prepare_data_for_plotting(data_snv, overall_consensus_drugs_per_ct_columns, input_colnames, "percent_all_support_drugs_ct")
df_overall_consensus_drugs_per_ct_cnv_sorted = prepare_data_for_plotting(data_cnv, overall_consensus_drugs_per_ct_columns, input_colnames, "percent_all_support_drugs_ct")


# Combine SNV and CNV datasets
# Sanity check that required input columns can be found
df_overall_consensus_drugs_per_ct =  combine_snv_and_cnv_data_for_plotting(df_overall_consensus_drugs_per_ct_snv_sorted, df_overall_consensus_drugs_per_ct_cnv_sorted, plotting_columns)

# Extract relevant features from the variable names in preparation for plotting
df_overall_consensus_drugs_per_ct$ct_class = unlist(lapply(strsplit(as.character(df_overall_consensus_drugs_per_ct$variable), "_"), tail, n = 1L))
df_overall_consensus_drugs_per_ct$support_type = unlist(lapply(strsplit(as.character(df_overall_consensus_drugs_per_ct$variable), "_"), `[`, 3))
df_overall_consensus_drugs_per_ct$support_type[df_overall_consensus_drugs_per_ct$support_type == "drugs"] = "mixed"
# Sort "ct" classes
ct_order = c("ct", "gt", "nct")
df_overall_consensus_drugs_per_ct$ct_class = factor(df_overall_consensus_drugs_per_ct$ct_class, levels=ct_order)
# Sort types of consensus drugs according to the underlying predictions
consensus_drug_order = c("support", "resistance", "conflict", "unknown", "mixed")
df_overall_consensus_drugs_per_ct$support_type = factor(df_overall_consensus_drugs_per_ct$support_type, levels=consensus_drug_order)
...
# Combined version of box plot
# Showing SNVs and CNVs as facets (drug numbers grouped by tier3 exclusion/inclusion)
outfile_overall_consensus_drugs_fraction_per_ct_box = paste0(opt$outfile_tag, ".boxplot_fraction_overall_consensus_drugs_distribution_per_ct.pdf")
p6c = ggplot(df_overall_consensus_drugs_per_ct, aes(x=ct_class, y=value, fill=support_type)) +
  # geom_boxplot(outlier.shape=NA, outlier.size=0, notch=FALSE) +
  geom_point(position=position_jitterdodge(jitter.width=0.65, jitter.height=0.65, seed=123), aes(color=support_type), size=1, alpha=0.9) +
  ylab("Percent of overall consensus drugs") + 
  xlab("") +
  facet_grid(dataset ~ .) +
  theme(legend.justification = c(1, 1),
  ...
  scale_fill_manual(name="Type of prediction", breaks=c("support", "resistance", "conflict", "unknown", "mixed"),
                    labels=c("All-support", "All-resistance", "All-conflict", "All-unknown", "Mixed"), values=consensus_cols) +
  scale_color_manual(name="Type of prediction", breaks=c("support", "resistance", "conflict", "unknown", "mixed"),
                     labels=c("All-support", "All-resistance", "All-conflict", "All-unknown", "Mixed"), values=consensus_cols)
# plot(p6c)
# ggsave(outfile_overall_consensus_drugs_fraction_per_ct_box, p6c, width=10, height=8, units="in", dpi=1200)
...
## PERCENTS - WITH TIER3 VARIANT STATS
## Same version as above but showing stats excluding tier3 variants

# Sanity check that required input columns can be found
overall_consensus_drugs_per_ct_columns = c("percent_all_support_drugs_ct", "percent_all_resistance_drugs_ct", "percent_all_conflict_drugs_ct", "percent_all_unknown_drugs_ct", "percent_mixed_drugs_ct",
                                           "percent_all_support_drugs_gt", "percent_all_resistance_drugs_gt", "percent_all_conflict_drugs_gt", "percent_all_unknown_drugs_gt", "percent_mixed_drugs_gt",
                                           "percent_all_support_drugs_nct", "percent_all_resistance_drugs_nct", "percent_all_conflict_drugs_nct", "percent_all_unknown_drugs_nct", "percent_mixed_drugs_nct",
                                           "percent_all_support_drugs_ct_no_tier3", "percent_all_resistance_drugs_ct_no_tier3", "percent_all_conflict_drugs_ct_no_tier3", "percent_all_unknown_drugs_ct_no_tier3", "percent_mixed_drugs_ct_no_tier3",
                                           "percent_all_support_drugs_gt_no_tier3", "percent_all_resistance_drugs_gt_no_tier3", "percent_all_conflict_drugs_gt_no_tier3", "percent_all_unknown_drugs_gt_no_tier3", "percent_mixed_drugs_gt_no_tier3",
                                           "percent_all_support_drugs_nct_no_tier3", "percent_all_resistance_drugs_nct_no_tier3", "percent_all_conflict_drugs_nct_no_tier3", "percent_all_unknown_drugs_nct_no_tier3", "percent_mixed_drugs_nct_no_tier3")
df_overall_consensus_drugs_per_ct_snv_sorted = prepare_data_for_plotting(data_snv, overall_consensus_drugs_per_ct_columns, input_colnames, "percent_all_support_drugs_ct")
df_overall_consensus_drugs_per_ct_cnv_sorted = prepare_data_for_plotting(data_cnv, overall_consensus_drugs_per_ct_columns, input_colnames, "percent_all_support_drugs_ct")
...
# Extract relevant features from the variable names in preparation for plotting
df_overall_consensus_drugs_per_ct$tier3_variants = ifelse(grepl("_no_tier3", df_overall_consensus_drugs_per_ct$variable), "Excluding\ntier3", "Including\ntier3")
df_overall_consensus_drugs_per_ct$tier3_variants = factor(df_overall_consensus_drugs_per_ct$tier3_variants, levels=c("Including\ntier3", "Excluding\ntier3"))
df_overall_consensus_drugs_per_ct$interim_col = gsub("_no_tier3", "", df_overall_consensus_drugs_per_ct$variable)
df_overall_consensus_drugs_per_ct$ct_class = unlist(lapply(strsplit(as.character(df_overall_consensus_drugs_per_ct$interim_col), "_"), tail, n = 1L))
df_overall_consensus_drugs_per_ct$support_type = unlist(lapply(strsplit(as.character(df_overall_consensus_drugs_per_ct$variable), "_"), `[`, 3))
df_overall_consensus_drugs_per_ct$support_type[df_overall_consensus_drugs_per_ct$support_type == "drugs"] = "mixed"
# Sort type of "ct" classes and of consensus predictions
ct_order = c("ct", "gt", "nct")
df_overall_consensus_drugs_per_ct$ct_class = factor(df_overall_consensus_drugs_per_ct$ct_class, levels=ct_order)
consensus_drug_order = c("support", "resistance", "conflict", "unknown", "mixed")
df_overall_consensus_drugs_per_ct$support_type = factor(df_overall_consensus_drugs_per_ct$support_type, levels=consensus_drug_order)
...
outfile_overall_consensus_drugs_fraction_per_ct_box = paste0(opt$outfile_tag, ".boxplot_fraction_overall_consensus_drugs_distribution_per_ct_with_no_tier3.pdf")
p12b = ggplot(df_overall_consensus_drugs_per_ct, aes(x=ct_class, y=value, fill=support_type)) +
  # geom_boxplot(outlier.shape=NA, outlier.size=0, notch=FALSE) +
  geom_point(position=position_jitterdodge(jitter.width=0.65, jitter.height=0.65, seed=123), aes(color=support_type), size=1, alpha=0.9) +
  ylab("Percent of overall consensus drugs") + 
  xlab("") +
  facet_grid(dataset ~ tier3_variants) +
  theme(legend.justification = c(1, 1),
        legend.text=element_text(size=12, color="black"),
        legend.title=element_text(size=15, color="black"),
        strip.text=element_text(size=12)) +
  ...
  scale_color_manual(name="Type of prediction", breaks=c("support", "resistance", "conflict", "unknown", "mixed"),
                     labels=c("All-support", "All-resistance", "All-conflict", "All-unknown", "Mixed"), values=consensus_cols)
# plot(p12b)
# ggsave(outfile_overall_consensus_drugs_fraction_per_ct_box, p12b, width=10, height=8, units="in", dpi=1200)



## ABSOLUTE NUMBERS - WITHOUT TIER3 VARIANT STATS
## DISTRIBUTION OF OVERALL CONSENSUS DRUG PREDICTIONS PER "CT" CLASS


# Sanity check that required input columns can be found
overall_consensus_drugs_per_ct_columns = c("n_all_support_drugs_ct", "n_all_resistance_drugs_ct", "n_all_conflict_drugs_ct", "n_all_unknown_drugs_ct", "n_mixed_drugs_ct",
                                           "n_all_support_drugs_gt", "n_all_resistance_drugs_gt", "n_all_conflict_drugs_gt", "n_all_unknown_drugs_gt", "n_mixed_drugs_gt",
                                           "n_all_support_drugs_nct", "n_all_resistance_drugs_nct", "n_all_conflict_drugs_nct", "n_all_unknown_drugs_nct", "n_mixed_drugs_nct")
df_overall_consensus_drugs_per_ct_snv_sorted = prepare_data_for_plotting(data_snv, overall_consensus_drugs_per_ct_columns, input_colnames, "n_all_support_drugs_ct")
df_overall_consensus_drugs_per_ct_cnv_sorted = prepare_data_for_plotting(data_cnv, overall_consensus_drugs_per_ct_columns, input_colnames, "n_all_support_drugs_ct")
...
outfile_overall_consensus_drugs_n_per_ct_box = paste0(opt$outfile_tag, ".boxplot_n_overall_consensus_drugs_distribution_per_ct.pdf")
p12c = ggplot(df_overall_consensus_drugs_per_ct, aes(x=ct_class, y=value, fill=support_type)) +
  # geom_boxplot(outlier.shape=NA, outlier.size=0, notch=FALSE) +
  geom_point(position=position_jitterdodge(jitter.width=0.65, jitter.height=0.65, seed=123), aes(color=support_type), size=1, alpha=0.9) +
  ylab("Number of overall consensus drugs") + 
  xlab("") +
  facet_grid(dataset ~ .) +
  theme(legend.justification = c(1, 1),
        legend.text=element_text(size=12, color="black"),
  ...
  scale_color_manual(name="Type of prediction", breaks=c("support", "resistance", "conflict", "unknown", "mixed"),
                     labels=c("All-support", "All-resistance", "All-conflict", "All-unknown", "Mixed"), values=consensus_cols)
# plot(p12c)
# ggsave(outfile_overall_consensus_drugs_n_per_ct_box, p12c, width=10, height=8, units="in", dpi=1200)



## ABSOLUTE NUMBERS - WITH TIER3 VARIANT STATS
## Same version as above but showing stats excluding tier3 variants
...
overall_consensus_drugs_per_ct_columns = c("n_all_support_drugs_ct", "n_all_resistance_drugs_ct", "n_all_conflict_drugs_ct", "n_all_unknown_drugs_ct", "n_mixed_drugs_ct",
                                           "n_all_support_drugs_gt", "n_all_resistance_drugs_gt", "n_all_conflict_drugs_gt", "n_all_unknown_drugs_gt", "n_mixed_drugs_gt",
                                           "n_all_support_drugs_nct", "n_all_resistance_drugs_nct", "n_all_conflict_drugs_nct", "n_all_unknown_drugs_nct", "n_mixed_drugs_nct",
                                           "n_all_support_drugs_ct_no_tier3", "n_all_resistance_drugs_ct_no_tier3", "n_all_conflict_drugs_ct_no_tier3", "n_all_unknown_drugs_ct_no_tier3", "n_mixed_drugs_ct_no_tier3",
                                           "n_all_support_drugs_gt_no_tier3", "n_all_resistance_drugs_gt_no_tier3", "n_all_conflict_drugs_gt_no_tier3", "n_all_unknown_drugs_gt_no_tier3", "n_mixed_drugs_gt_no_tier3",
                                           "n_all_support_drugs_nct_no_tier3", "n_all_resistance_drugs_nct_no_tier3", "n_all_conflict_drugs_nct_no_tier3", "n_all_unknown_drugs_nct_no_tier3", "n_mixed_drugs_nct_no_tier3")
df_overall_consensus_drugs_per_ct_snv_sorted = prepare_data_for_plotting(data_snv, overall_consensus_drugs_per_ct_columns, input_colnames, "n_all_support_drugs_ct")
df_overall_consensus_drugs_per_ct_cnv_sorted = prepare_data_for_plotting(data_cnv, overall_consensus_drugs_per_ct_columns, input_colnames, "n_all_support_drugs_ct")
...
outfile_overall_consensus_drugs_n_per_ct_box = paste0(opt$outfile_tag, ".boxplot_n_overall_consensus_drugs_distribution_per_ct_with_no_tier3.pdf")
p12d = ggplot(df_overall_consensus_drugs_per_ct, aes(x=ct_class, y=value, fill=support_type)) +
  # geom_boxplot(outlier.shape=NA, outlier.size=0, notch=FALSE) +
  geom_point(position=position_jitterdodge(jitter.width=0.65, jitter.height=0.65, seed=123), aes(color=support_type), size=1, alpha=0.9) +
  ylab("Number of overall consensus drugs") + 
  xlab("") +
  ...
  scale_color_manual(name="Type of prediction", breaks=c("support", "resistance", "conflict", "unknown", "mixed"),
                     labels=c("All-support", "All-resistance", "All-conflict", "All-unknown", "Mixed"), values=consensus_cols)
# plot(p12d)
# ggsave(outfile_overall_consensus_drugs_n_per_ct_box, p12d, width=10, height=8, units="in", dpi=1200)
